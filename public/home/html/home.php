     ...
     <div class="home__container">
        ...
        <div class="content__container">
            ...
            <div class="content__right scrollImage__anchor">
                <img src="../../assets/tengyart-joGq-Kjpvlk-unsplash.jpg" alt="Degustation.jpg">
        ...
        <div class="content__container">
            <div class="content__right scrollImage__anchor" >
                <img src="../../assets/frederic-paulussen-jqZe2mziRDI-unsplash.jpg" alt="Degustation.jpg">
            </div>
            <div class="content__leftInverted scrollContent__anchorInverted">
                ...
                <div class="content__button">
                    <a href="../../store/html/store.html" class="brk-btn">DECOUVREZ NOTRE BOUTIQUE</a>
                </div>
            </div>
        </div>
        ...
        <div class="content__container">
            ...
            <div class="content__right scrollImage__anchor">
                <img src="../../assets/henry-fournier-xcDrhb4mhLA-unsplash.jpg" alt="Degustation.jpg">
